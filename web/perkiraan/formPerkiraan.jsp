        ...
        <tr>
            <td>
                <table cellSpacing="0" cellPadding="10" width="100%" border="0">
                    <tr>
                        <td class="ver12gray" bgColor="#dbdbd4">Add/Edit Tabel Perkiraan</td>
                    </tr>
                </table>
                                ...
                                <tr>
                                    ...
                                    <td class="ver10gray">
                                        <logic:equal name="action" value="insert">
                                                <html:form action="/insertPerkiraan" method="POST">
                                                <table border="0">
                                                        <jsp:include page="/perkiraan/formPerkiraanInc.jsp"/>
                                                        <tr>
                                        ...
                                        <logic:equal name="action" value="update">
                                                <html:form action="/updatePerkiraan" method="POST">
                                                <table border="0">
                                                        <jsp:include page="/perkiraan/formPerkiraanInc.jsp"/>
                                                        <tr>
                                        ...
                                        <logic:equal name="action" value="select">
                                                <html:form action="/selectPerkiraan" method="POST">
                                                <table border="0">
                                                        <jsp:include page="/perkiraan/formPerkiraanInc.jsp"/>
                                                        <tr>
