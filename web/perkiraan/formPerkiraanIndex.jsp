...
<head>
    ...
    <script>
        ...
        function PopUpAddEdit(id, idPerkiraan) {				
                var url;
                if (id==0) {
                    url = 'newPerkiraan.do';
                } else if (id==1) {
                    url = 'findPerkiraan.do?idPerkiraan=' + idPerkiraan;
                } else if (id==2) {
                    //url = 'deletePerkiraan.do?idPerkiraan=' + idPerkiraan;
                } else if (id==3) {
                    url = 'viewPerkiraan.do?idPerkiraan=' + idPerkiraan;
                } else if (id==4) {
                    url = 'printPerkiraan.do?idPerkiraan=' + idPerkiraan;
                } else if (id==5) {
                    url = 'viewIncome.do?idPerkiraan=' + idPerkiraan;    
                } else if (id==6) {
                    url = 'newIncome.do?idPerkiraan=' + idPerkiraan;
                }                   
                popUp('Perkiraan',url,'475','250');
        }		
    </script>
</head>
<body>
            ...
            <table width="100%" border="0" cellspacing="0" cellpadding="0">	
                                ...
                                <table cellSpacing="0" cellPadding="0" width="100%" border="0">
                                        <tr>
                                                ...
                                                <td vAlign="middle" noWrap align="right" width="130">
                                                  <a class="link1" href="Javascript:PopUpAddEdit('0','');">Add New Perkiraan <IMG height="26" src="<%=request.getContextPath()%>/Images/icon_add_new.gif" width="26" align="absMiddle" border="0"></a>
                                                </td>
                                        </tr>
                                </table>
                        </td>
               ...
               <tr>
                    ...
                    <td class="ver12gray">	
                        ...
                        <display:table name="perkiraans" id="perkiraan" class="report" requestURI="/perkiraan/perkiraan.do"    
                             decorator="com.wings.struts.decorators.PerkiraanWrapper" pagesize="10">  
                            <display:column property="idPerkiraan" title="Id" sortable="true"/>      
