            ...
            <table width="100%" border="0" cellspacing="0" cellpadding="0">	
               ...
               <tr>
                    ...
                    <td class="ver12gray">
                        ...
                        <display:table name="SOAList" id="invoiceAIDetail" class="report" requestURI="/payment/payment.do"    
                            ...
                            <display:column property="hawb" title="Master" sortable="true" />
