...
<body bgColor="#c4c4c4" >
    ...
    <table cellSpacing="0" cellPadding="0" width="1250" align="center" border="0">
        <tr>
            <td>
                <table cellSpacing="0" cellPadding="10" width="100%" border="0">
                    <tr>
                        <td class="ver12gray" bgColor="#dbdbd4">Add/Edit Receivable</td>
                    </tr>
                </table>
                    ...
                    <tr>
                        <td>
                            <table class="ver10gray" cellSpacing="2" cellPadding="2" width="100%" border="0">
                                ...
                                <tr>
                                    <td width="10">&nbsp;</td>
                                    <td class="ver10gray" width="100%" >	
                                        <logic:equal name="action" value="insert">
                                            <html:form action="/insertPayment" method="POST">
                                            <table border="0" width="100%" >
                                                    <jsp:include page="/payment/formPaymentInc.jsp"/>
                                                    <tr>
                                                            <td colspan="2"><html:submit property="action" value="Save"/></td>
                                                    </tr>
                                            </table>
                                            </html:form>
                                    </logic:equal>
                                    <logic:equal name="action" value="update">
                                            <html:form action="/updatePayment" method="POST">
                                            <table border="0">
                                                    <jsp:include page="/payment/formPaymentInc.jsp"/>
                                                    <tr>
                                                            <td colspan="2"><html:submit property="action" value="update"/></td>
                                                    </tr>
                                            </table>
                                            </html:form>
                                    </logic:equal>
                                    <logic:equal name="action" value="select">
                                            <html:form action="/selectPayment" method="POST">
                                            <table border="0">
                                                    <jsp:include page="/payment/formPaymentInc.jsp"/>
                                                    <tr>
                                                            <td colspan="2"><html:submit property="action" value="find"/></td>
                                                    </tr>
                                            </table>
                                            </html:form>
                                    </logic:equal>
