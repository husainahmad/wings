        ...
        <tr>
            <td>
                <table cellSpacing="0" cellPadding="10" width="100%" border="0">
                    <tr>
                        <td class="ver12gray" bgColor="#dbdbd4">Update Faktur Pajak</td>
                    </tr>
                </table>
                            ...
                            <table class="ver10gray" cellSpacing="2" cellPadding="2" width="100%" border="0">
                                ...
                                <tr>
                                    ...
                                    <logic:equal name="action" value="insert">
                                            <html:form action="/insertTax" method="POST">
                                            <table border="0" width="100%">
                                                    <jsp:include page="/tax/formTaxInc.jsp"/>
                                                    <tr>
                                    ...
                                    <logic:equal name="action" value="update">
                                            <html:form action="/updateTax" method="POST">
                                            <table border="0" width="100%">
                                                    <jsp:include page="/tax/formTaxInc.jsp"/>
                                                    <tr>
                                    ...
                                    <logic:equal name="action" value="select">
                                            <html:form action="/selectTax" method="POST">
                                            <table border="0" width="100%">
                                                    <jsp:include page="/tax/formTaxInc.jsp"/>
                                                    <tr>
