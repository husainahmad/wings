...
<head>
    ...
    <script>
        ...
        function PopUpAddEdit() {				
                var url = 'printFakturPajak.do?';
                url += 'from=' + document.getElementById("invoiceDateFrom").value;
                url += '&to=' + document.getElementById("invoiceDateTo").value;                                       
                try {
                    url += '&idJobType=' + document.getElementById("idJobType").value;    
                } catch (e) {
                    url += '';    
                } 
               
                popUp('printFakturPajak',url,'750','500');
                    ...
                    <td class="ver12gray" align="center">	
                      <form action="#">
                        <table class="ver10gray" cellSpacing="2" cellPadding="2" width="450" border="0" bgcolor="#eeeee6"
                            ...
                            <tr>
                                    <td vAlign="middle" colSpan="2" height="30" align="center"><b><u>Report Receivable Customer</u></b></td>
                            </tr>                            
                            <tr vAlign="top">
                                    <td><b>From</b></td>
                                    <td>
                            ...
                            <tr vAlign="middle">
                                <td><b>Div</b></td>
                                <td>
                                    <select name="idJobType" id="idJobType">
