        ...
        <tr>
            <td>
                <table cellSpacing="0" cellPadding="10" width="100%" border="0">
                    <tr>
                        <td class="ver12gray" bgColor="#dbdbd4">Add/Edit Jobsheet (SO) <span id="indicator" style="display:none;">Loading......</span></td>
                    </tr>
                </table>
                            ...
                            <table class="ver10gray" cellSpacing="2" cellPadding="2" width="100%" border="0">
                                ...
                                <tr>
                                    ...
                                    <logic:equal name="action" value="insert">
                                            <html:form action="/insertJobsheetso" method="POST">
                                            <table border="0" width="100%">
                                                    <jsp:include page="/jobsheet/formJobSheetsoInc.jsp"/>
                                                    <tr>
                                    ...
                                    <logic:equal name="action" value="updateAsNew">
                                            <html:form action="/insertAsNewJobsheetso" method="POST">
                                            <table border="0" width="100%">
                                                    <jsp:include page="/jobsheet/formJobSheetsoInc.jsp"/>
                                                    <tr>
                                                            <td colspan="2"><html:submit property="action" value="Save"/>&nbsp;&nbsp;&nbsp;<html:submit property="action" value="Print"/></td>
                                    ...
                                    <logic:equal name="action" value="update">
                                            <html:form action="/updateJobsheetso" method="POST">
                                            <table border="0" width="100%">
                                                    <jsp:include page="/jobsheet/formJobSheetsoInc.jsp"/>
                                                    <tr>
                                                            <td colspan="2">
