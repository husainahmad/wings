        ...
        <tr>
            <td>
                <table cellSpacing="0" cellPadding="10" width="100%" border="0">
                    <tr>
                        <td class="ver12gray" bgColor="#dbdbd4">Add/Edit Jobsheet (SI) <span id="indicator" style="display:none;">Loading......</span></td>
                    </tr>
                </table>
                            ...
                            <table class="ver10gray" cellSpacing="2" cellPadding="2" width="100%" border="0">
                                ...
                                <tr>
                                    ...
                                    <logic:equal name="action" value="insert">
                                            <html:form action="/insertJobsheetsi" method="POST">
                                            <table border="0" width="100%">
                                                    <jsp:include page="/jobsheet/formJobSheetsiInc.jsp"/>
                                                    <tr>
                                    ...
                                    <logic:equal name="action" value="updateAsNew">
                                            <html:form action="/insertAsNewJobsheetsi" method="POST">
                                            <table border="0" width="100%">
                                                    <jsp:include page="/jobsheet/formJobSheetsiInc.jsp"/>
                                                    <tr>
                                                            <td colspan="2"><html:submit property="action" value="Save"/>&nbsp;&nbsp;&nbsp;<html:submit property="action" value="Print"/></td>
                                    ...
                                    <logic:equal name="action" value="update">
                                            <html:form action="/updateJobsheetsi" method="POST">
                                            <table border="0" width="100%">
                                                    <jsp:include page="/jobsheet/formJobSheetsiInc.jsp"/>
                                                    <tr>
                                                            <td colspan="2">
