...
<body bgColor="#c4c4c4" >
    ...
    <table cellSpacing="0" cellPadding="0" width="1150" align="center" border="0">
        <tr>
            <td>
                <table cellSpacing="0" cellPadding="10" width="100%" border="0">
                    <tr>
                        <td height="40" class="ver12gray" bgColor="#dbdbd4">Add/Edit Jobsheet (AI) <span id="indicator" style="display:none;">Loading......</span></td>
                    </tr>
                </table>
                            ...
                            <table class="ver10gray" cellSpacing="2" cellPadding="2" width="100%" border="0">
                                ...
                                <tr>
                                    ...
                                    <logic:equal name="action" value="insert">
                                            <html:form action="/insertJobsheetai" method="POST">
                                            <table border="0" width="100%">                                                
                                                    <jsp:include page="/jobsheet/formJobSheetaiInc.jsp"/>
                                    ...
                                    <logic:equal name="action" value="updateAsNew">
                                            <html:form action="/insertAsNewJobsheetai" method="POST">
                                            <table border="0" width="100%">                                                
                                                    <jsp:include page="/jobsheet/formJobSheetaiInc.jsp"/>
                                                    
                                                    <tr>
                                                            <td colspan="2"><html:submit property="action" value="Save"/>&nbsp;&nbsp;&nbsp;<html:submit property="action" value="Print"/></td>
                                                    </tr>
                                            </table>
                                            </html:form>
                                    </logic:equal>
                                    <logic:equal name="action" value="update">
                                            <html:form action="/updateJobsheetai" method="POST">
                                            <table border="0" width="100%">
                                                    <jsp:include page="/jobsheet/formJobSheetaiInc.jsp"/>
                                                    <tr>
                                                            <td colspan="2">
                                                                 <logic:equal name="status" value="0">
                                                                     <html:submit property="action" value="Update"/>&nbsp;&nbsp;&nbsp;
                                                                        <html:submit property="action" value="Print"/>&nbsp;&nbsp;&nbsp;
                                                                        <%
                                                                            if (request.getSession()!=null && request.getSession().getAttribute("userAuthorityId")!=null) {
                                                                                if (request.getSession().getAttribute("userAuthorityId").equals("AC")) {
                                                                        %>
                                                                                <html:submit property="action" value="ACC"/>
                                                                        <%
                                                                                }
                                                                            }
                                                                        %>                                                                                                                              
                                                                 ...
                                                                 <logic:equal name="status" value="1">
                                                                      <%
                                                                            if (request.getSession()!=null && request.getSession().getAttribute("userAuthorityId")!=null) {
                                                                                if (request.getSession().getAttribute("userAuthorityId").equals("AC")) {
                                                                        %>
                                                                                <html:submit property="action" value="UNACC"/>
                                                                        <%
                                                                                }
                                                                            }
                                                                        %>      
                                    ...
                                    <logic:equal name="action" value="copy">
                                            ...
                                            <table border="0" width="100%">
                                                    <jsp:include page="/jobsheet/formJobSheetaiInc.jsp"/>
                                                    <tr>
                                                            <td colspan="2"><html:submit property="action" value="Save Copy"/>&nbsp;&nbsp;&nbsp;<html:submit property="action" value="Print"/></td>
                                                    </tr>
                                            </table>
                                            </html:form>
                                    </logic:equal>
