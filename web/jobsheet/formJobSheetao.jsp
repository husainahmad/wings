        ...
        <tr>
            <td>
                <table cellSpacing="0" cellPadding="10" width="100%" border="0">
                    <tr>
                        <td class="ver12gray" bgColor="#dbdbd4">Add/Edit Jobsheet (AO) <span id="indicator" style="display:none;">Loading......</span></td>
                    </tr>
                </table>
                            ...
                            <table class="ver10gray" cellSpacing="2" cellPadding="2" width="100%" border="0">
                                ...
                                <tr>
                                    ...
                                    <logic:equal name="action" value="insert">
                                            <html:form action="/insertJobsheetao" method="POST">
                                            <table border="0" width="100%">
                                                
                                                    <jsp:include page="/jobsheet/formJobSheetaoInc.jsp"/>
                                    ...
                                    <logic:equal name="action" value="updateAsNew">
                                            <html:form action="/insertAsNewJobsheetao" method="POST">
                                            <table border="0" width="100%">
                                    ...
                                    <logic:equal name="action" value="update">
                                            <html:form action="/updateJobsheetao" method="POST">
                                            <table border="0">
                                                    <jsp:include page="/jobsheet/formJobSheetaoInc.jsp"/>
                                                    <tr>
                                                            <td colspan="2">
