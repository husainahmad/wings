...
<head>
    ...
    <script>
        ...
        function PopUpAddEdit(id, idJobSheet) {				
                var url;
                if (id==0) {
                    url = 'newJobsheetsi.do';
                } else if (id==1) {
                    url = 'findJobsheetsi.do?idJobSheet=' + idJobSheet;
                } else if (id==2) {
                    question = confirm('Are you sure want to delete this record?'); 
                    if (question) {
                        window.location='deleteJobsheetsi.do?idJobSheet='+ idJobSheet;
                        return;
                    } else {
                        return;
                    }                    
                } else if (id==3) {
                    url = 'viewJobsheetsi.do?idJobSheet=' + idJobSheet;                
                } else if (id==5) {
                    url = 'findAsNewJobsheetsi.do?idJobSheet=' + idJobSheet;
                } else if (id==6) {
                    url = 'copyJobsheetsi.do?idJobSheet=' + idJobSheet;
                } else if (id==4) {
                    url = 'printJobsheetsi.do?idJobSheet=' + idJobSheet;
                } else if (id==7) {
                    url = 'printJobsheetsiHeader.do?idJobSheet=' + idJobSheet;
                }
                popUp('Jobsheetsi',url,'1200','600');
        }		
    </script>
</head>
<body>
            ...
            <table width="100%" border="0" cellspacing="0" cellpadding="0">	
               ...
               <tr>
                        ...
                        <td class="ver12gray">
                                <table cellSpacing="0" cellPadding="0" width="100%" border="0">
                                        <tr>
                                            <html:form action="/jobsheetsi" method="GET">
                                                <td width="100%">&nbsp;
                                                </td>
                                                ...
                                                <td vAlign="middle" noWrap align="right">
                                                    <html:select  property="query">
                                                        ...
                                                        <html:option value="8">Shipping Line</html:option>
                                                        <html:option value="9">Feeder Vessel</html:option>
                                                        <html:option value="10">HBL</html:option>
                                                        <html:option value="11">MBL</html:option>
                                                ...
                                                <td vAlign="middle" noWrap align="right" width="130">
                                                    <a class="link1" href="Javascript:PopUpAddEdit('0','');">Add New Jobsheet (SI) <IMG height="26" src="<%=request.getContextPath()%>/Images/icon_add_new.gif" width="26" align="absMiddle" border="0"></a>
                                                </td>
                                            </html:form>
                                        </tr>
                                </table>
               ...
               <tr>
                    ...
                    <td class="ver12gray">	
                        ...
                        <display:table name="jobsheetsis" id="jobsheet" class="report" requestURI="/jobsheet/jobsheetsi.do"    
                             decorator="com.wings.struts.decorators.JobsheetsiWrapper" pagesize="10">                            
