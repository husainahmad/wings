...
<head>
    ...
    <script>
        ...
        function PopUpAddEdit(id, idJobSheet) {				
                var url;
                if (id==0) {
                    url = 'newJobsheetso.do';
                } else if (id==1) {
                    url = 'findJobsheetso.do?idJobSheet=' + idJobSheet;
                } else if (id==2) {
                    question = confirm('Are you sure want to delete this record?'); 
                    if (question) {
                        window.location='deleteJobsheetso.do?idJobSheet='+ idJobSheet;
                        return;
                    } else {
                        return;
                    }
                } else if (id==3) {
                    url = 'viewJobsheetso.do?idJobSheet=' + idJobSheet;                 
                } else if (id==5) {
                    url = 'findAsNewJobsheetso.do?idJobSheet=' + idJobSheet;
                } else if (id==6) {
                    url = 'copyJobsheetso.do?idJobSheet=' + idJobSheet;
                } else if (id==4) {
                    url = 'printJobsheetso.do?idJobSheet=' + idJobSheet;
                } else if (id==7) {
                    url = 'printJobsheetsoHeader.do?idJobSheet=' + idJobSheet;
                }
                popUp('Jobsheetso',url,'1000','600');
        }		
    </script>
</head>
<body>
            ...
            <table width="100%" border="0" cellspacing="0" cellpadding="0">	
               ...
               <tr>
                        ...
                        <td class="ver12gray">
                                <table cellSpacing="0" cellPadding="0" width="100%" border="0">
                                        <tr>
                                            <html:form action="/jobsheetso" method="GET">
                                            <td width="100%">&nbsp;
                                            </td>
                                            ...
                                            <td vAlign="middle" noWrap align="right" width="130">
                                                <a class="link1" href="Javascript:PopUpAddEdit('0','');">Add New Jobsheet (SO) <IMG height="26" src="<%=request.getContextPath()%>/Images/icon_add_new.gif" width="26" align="absMiddle" border="0"></a>
                                            </td>
                                        </tr>
                                        </html:form>
                                </table>
               ...
               <tr>
                    ...
                    <td class="ver12gray">	
                        ...
                        <display:table name="jobsheetsos" id="jobsheet" class="report" requestURI="/jobsheet/jobsheetso.do"    
                             decorator="com.wings.struts.decorators.JobsheetsoWrapper" pagesize="10">                            
