...
<head>
    ...
    <script>
        ...
        function PopUpAddEdit() {				
                ...
                popUp('printMonthlyBB',url,'750','500');
...
<table border="0" cellspacing="0" cellpadding="0" width="1003" align="center">
    ...
    <tr valign=top>
        <td width="260" height="400" background="<%=request.getContextPath()%>/Images/menu_bg.gif" valign="top">
                ...
                <tr>
                    ...
                    <td class="ver12gray" align="center">	
                        <html:form action="/printBB" method="GET">                                                
                            <table class="ver10gray" cellSpacing="2" cellPadding="2" width="550" border="0" bgcolor="#eeeee6"
                                ...
                                <tr>
                                    <td vAlign="middle" colSpan="2" height="30" align="center"><b><u>Report Monthly Buku Besar</u></b></td>
                                </tr>                            
                                <tr vAlign="top">
                                    <td><b>Month</b></td>
                                    <td>
                                ...
                                <tr>
                                    <td><b>Account</b></td>                                    
                                    <td><html:text property="idAccount" size="13" styleId="idAccount"/>&nbsp;
                                        <input type="text" id="accountDesc" name="accountDesc" value="" size="38" >
