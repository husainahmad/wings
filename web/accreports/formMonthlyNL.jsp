...
<head>
    ...
    <script>
        ...
        function PopUpAddEdit() {				
                ...
                popUp('printMonthlyNLAktiva',url,'750','500');
                    ...
                    <td class="ver12gray" align="center">	
                        <html:form action="/printBB" method="GET">                                                
                            <table class="ver10gray" cellSpacing="2" cellPadding="2" width="450" border="0" bgcolor="#eeeee6"
                                ...
                                <tr>
                                    <td vAlign="middle" colSpan="2" height="30" align="center"><b><u>Report Neraca</u></b></td>
                                </tr>       
                                <html:hidden property="month" styleId="month" value="12"/>
                                <%--
                                <tr vAlign="top">
                                    <td><b>Month</b></td>
                                    <td>
                                ...
                                <html:hidden property="idAccount" styleId="idAccount" value=""/>
                                <%--
                                <tr>
                                    <td><b>Account</b></td>                                    
