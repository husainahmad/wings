            ...
            <table width="100%" border="0" cellspacing="0" cellpadding="0">	
                ...
                <tr>
                    ...
                    <td class="ver12gray" align="center">	
                        <html:form action="/reportJurnalUmum" method="GET">                                                
                            <table class="ver10gray" cellSpacing="2" cellPadding="2" width="450" border="0" bgcolor="#eeeee6"
                                ...
                                <tr>
                                    <td vAlign="middle" colSpan="2" height="30" align="center"><b><u>Report Monthly Journal</u></b></td>
                                </tr>                            
                                <tr vAlign="top">
                                    <td><b>Month</b></td>
                                    <td>
                                ...
                                <tr>
                                    <td><b>Batch</b></td>                                    
                                    <td>
                                        <html:select  property="noBatch" styleId="noBatch">
