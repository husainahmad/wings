...
<head>
    ...
    <script>
        ...
        function PopUpAddEdit() {		
                var url = 'printTruckingSummary.do?';
                url += 'from=' + document.getElementById("invoiceDateFrom").value;
                url += '&to=' + document.getElementById("invoiceDateTo").value;                                       
                try {
                    url += '&idTransporter=' + document.getElementById("idTransporter").value;    
                } catch (e) {
                    url += '';    
                } 
                try {
                    url += '&perTransporter=' + document.getElementById("idTransporter").options[document.getElementById("idTransporter").selectedIndex].text;
                } catch (e) {
                    url += '';    
                }
                
                popUp('printTruckingSummary',url,'850','600');                               
                    ...
                    <td class="ver12gray" align="center">	
                      <form action="#">
                        <table class="ver10gray" cellSpacing="2" cellPadding="2" width="450" border="0" bgcolor="#eeeee6"
                            ...
                            <tr>
                                    <td vAlign="middle" colSpan="2" height="30" align="center"><b><u>Report Summary Trucking</u></b></td>
                            </tr>                            
                            <tr vAlign="top">
                                    <td><b>From</b></td>
                                    <td>
                            ...
                            <tr vAlign="top">
                                ...
                                <tr vAlign="top">
                                    <td><b>Trucking</b></td>
                                    <td>
                                        <select id="idTransporter">
                                            <option value="All">All</option>
                                            <logic:iterate name="truckingList" id="truck">
                                                <option value="<bean:write name="truck" property="idTransporter"/>"><bean:write name="truck" property="name"/></option>
                                            </logic:iterate>
                                        </select>                                            
                                    </td>                            
                                </tr>
