        ...
        <tr>
            <td>
                <table cellSpacing="0" cellPadding="10" width="100%" border="0">
                    <tr>
                        <td class="ver12gray" bgColor="#dbdbd4">Update Debit</td>
                    </tr>
                </table>
                                ...
                                <tr>
                                    ...
                                    <logic:equal name="action" value="insert">
                                            ...
                                            <table border="0" width="100%">
                                                    <jsp:include page="/debit/formDebitIncomeInc.jsp"/>
                                                    <tr>
                                                            <td colspan="2"><html:submit value="Update"/></td>
                                                    </tr>
                                                    <tr>
                                                            <td colspan="2"><br/><br/>*use this page for updating debit status</td>
                                                    </tr>
                                            </table>
                                            </html:form>
                                    </logic:equal>
