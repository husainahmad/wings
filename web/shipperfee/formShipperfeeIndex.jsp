...
<head>
    ...
    <script>
        ...
        function PopUpAddEdit(id, idShipperFee) {				
                var url;
                if (id==0) {
                    url = 'newShipperfee.do';
                } else if (id==1) {
                    url = 'findShipperfee.do?idShipperFee=' + idShipperFee;
                } else if (id==2) {
                    question = confirm('Are you sure want to delete this record?'); 
                    if (question) {
                        window.location='deleteShipperfee.do?idShipperFee=' + idShipperFee;
                        return;
                    } else {
                        return;
                    }                    
                } else if (id==3) {
                    url = 'viewShipperfee.do?idShipperFee=' + idShipperFee;
                }                 
                popUp('Shipperfee',url,'665','325');
        }		
    </script>
</head>
<body>
        ...
        <td width="840" class="ver12gray">
            ...
            <table width="100%" border="0" cellspacing="0" cellpadding="0">	
               ...
               <tr>
                        ...
                        <td class="ver12gray">
                                <table cellSpacing="0" cellPadding="0" width="100%" border="0">
                                    <html:form action="shipperfee" method="get">
                                        <tr>
                                            <td width="100%">&nbsp;
                                            </td>
                                            ...
                                            <td vAlign="middle" vAlign="middle" noWrap align="right">&nbsp;Name
                                            </td>
                                            <td class="ver10gray" vAlign="middle" noWrap align="right">&nbsp;
                                            ...
                                            <td vAlign="middle" noWrap align="right" width="130">
                                                <a class="link1" href="Javascript:PopUpAddEdit('0','');">Add New Shipper/Invoice Fee <IMG height="26" src="<%=request.getContextPath()%>/Images/icon_add_new.gif" width="26" align="absMiddle" border="0"></a>
                                            </td>
                                        </tr>
                                    </html:form>    
                                </table>
               ...
               <tr>
                    <td width="10">&nbsp;</td>
                    <td class="ver12gray">	
                       <display:table name="shipperfeeList" id="shipperfee" class="report" requestURI="/shipperfee/shipperfee.do"    
                             decorator="com.wings.struts.decorators.ShipperfeeWrapper" pagesize="10">                            
                ...
                <tr>
                    <td vAlign="top" colSpan="3"><br>&nbsp;&nbsp;
                        <a class="link1" target="_blank" href="printInvoiceFeeAction.do?idJobType=<bean:write name="shipperfeeForm" property="idJobType"/>"><IMG src="<%=request.getContextPath()%>/Images/print.gif" align="absMiddle" border="0"></a>
                    </td>
               </tr>
            </table>	
        </td>
