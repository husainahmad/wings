        ...
        <tr>
            <td>
                <table cellSpacing="0" cellPadding="10" width="100%" border="0">
                    <tr>
                        <td class="ver12gray" bgColor="#dbdbd4">Add/Edit Monthly Transaction <span id="indicator" style="display:none;">Loading......</span></td>
                    </tr>
                </table>
                            ...
                            <table class="ver10gray" cellSpacing="2" cellPadding="2" width="100%" border="0">
                                ...
                                <tr>
                                    ...
                                    <logic:equal name="action" value="insert">
                                            <html:form action="/insertTransactionacc" method="POST">
                                            <table border="0">
                                                    <jsp:include page="/transactionacc/formTransactionaccInc.jsp"/>
                                                    <tr>
                                                            <td colspan="2">
                                                                <html:submit property="action" value="Save"/>
                                                                &nbsp;
                                                                <html:submit property="action" value="Commit"/>
                                                                &nbsp;
                                                                <input type="button" name="btnClose" value="Close" onclick="closeWindow();">
                                                                <script>
                                                                    function closeWindow() {
                                                                        window.opener.document.getElementById('hidRefresh').value=1;                                                                        
                                                                        window.close();
                                                                    }
                                                                </script>
                                                            </td>
                                    ...
                                    <logic:equal name="action" value="update">
                                            <html:form action="/updateTransactionacc" method="POST">
                                            <table border="0">
                                                    <jsp:include page="/transactionacc/formTransactionaccEditInc.jsp"/>
                                                    <tr>
                                                            <td colspan="2">
                                    ...
                                    <logic:equal name="action" value="select">
                                            <html:form action="/transactionacc/selectTransactionacc" method="POST">
                                            <table border="0">
                                                    <jsp:include page="/struts/formTransactionaccInc.jsp"/>
                                                    <tr>
