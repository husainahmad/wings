...
<head>
    ...
    <script>
        ...
        function PopUpAddEdit(id, idTransporter) {				
                var url;
                if (id==0) {
                    url = 'newTransporter.do';
                } else if (id==1) {
                    url = 'findTransporter.do?idTransporter=' + idTransporter;
                } else if (id==2) {
                    question = confirm('Are you sure want to delete this record?'); 
                    if (question) {
                        window.location='deleteTransporter.do?idTransporter=' + idTransporter;
                        return;
                    } else {
                        return;
                    }                    
                } else if (id==3) {
                    url = 'viewTransporter.do?idTransporter=' + idTransporter;
                }                 
                popUp('Transporter',url,'775','500');
        }		
    </script>
</head>
<body>
            ...
            <table width="100%" border="0" cellspacing="0" cellpadding="0">	
               ...
               <tr>
                        ...
                        <td class="ver12gray">
                                <table cellSpacing="0" cellPadding="0" width="100%" border="0">
                                    <html:form action="/transporter" method="GET">
                                        <tr>
                                            <td width="100%">&nbsp;
                                            </td>
                                            ...
                                            <td class="ver10gray" vAlign="middle" noWrap align="right">
                                                <a class="link1" href="Javascript:PopUpAddEdit('0','');">Add New Transporter <IMG height="26" src="<%=request.getContextPath()%>/Images/icon_add_new.gif" width="26" align="absMiddle" border="0"></a>
                                            </td>
                                        </tr>
                                    </html:form>
                                </table>
               ...
               <tr>
                    ...
                    <td class="ver12gray">	
                        ...
                        <display:table name="transporters" id="transporters" class="report" requestURI="/transporter/transporter.do"    
                             decorator="com.wings.struts.decorators.TransporterWrapper" pagesize="10">                            
