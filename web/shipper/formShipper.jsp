        ...
        <tr>
            <td>
                <table cellSpacing="0" cellPadding="10" width="100%" border="0">
                    <tr>
                        <td class="ver12gray" bgColor="#dbdbd4">Add/Edit Forwarding</td>
                    </tr>
                </table>
                            ...
                            <table class="ver10gray" cellSpacing="2" cellPadding="2" width="100%" border="0">
                                ...
                                <tr>
                                    ...
                                    <logic:equal name="action" value="insert">
                                            <html:form action="/insertShipper" method="POST">
                                            <table border="0">
                                                    <jsp:include page="/shipper/formShipperInc.jsp"/>
                                                    <tr>
                                    ...
                                    <logic:equal name="action" value="update">
                                            <html:form action="/updateShipper" method="POST">
                                            <table border="0">
                                                    <jsp:include page="/shipper/formShipperInc.jsp"/>
                                                    <tr>
