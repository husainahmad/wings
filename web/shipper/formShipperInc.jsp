...
<%--
		<tr>
			<td>IdShipper:</td>
			<td><html:text property="idShipper" disabled="true"/></td>                        
		</tr>
                --%>
                <%--
                <html:hidden property="idShipper"/>
                --%>
                <logic:equal name="action" value="insert">
                        <tr>
                                <td>Id Forwarding:</td>
                                <td><html:text property="idShipper" size="13" onkeydown="if(event.keyCode==13) event.keyCode=9;"/></td>                        
                        </tr>
                </logic:equal>
                <logic:equal name="action" value="update">
                        <tr>
                                <td>Id Forwarding:</td>
                                <td><html:text property="idShipper" size="13" readonly="true"/></td>                        
                        </tr>
                </logic:equal>
