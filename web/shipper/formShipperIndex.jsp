...
<head>
    ...
    <script>
        ...
        function PopUpAddEdit(id, idShipper) {				
                var url;
                if (id==0) {
                    url = 'newShipper.do';
                } else if (id==1) {
                    url = 'findShipper.do?idShipper=' + idShipper;
                } else if (id==2) {
                    question = confirm('Are you sure want to delete this record?'); 
                    if (question) {
                        window.location='deleteShipper.do?idShipper=' + idShipper;
                        return;
                    } else {
                        return;
                    }                    
                } else if (id==3) {
                    url = 'viewShipper.do?idShipper=' + idShipper;
                }                 
                popUp('Shipper',url,'765','450');
        }		
    </script>
</head>
<body>
        ...
        <td width="840" class="ver12gray">
            ...
            <table width="100%" border="0" cellspacing="0" cellpadding="0">	
               ...
               <tr>
                        ...
                        <td class="ver12gray">
                                <table cellSpacing="0" cellPadding="0" width="100%" border="0">
                                    <html:form action="/shipper" method="GET">
                                        <tr>
                                            <td width="100%">&nbsp;
                                            </td>
                                            ...
                                            <td vAlign="middle" noWrap align="right" width="130">
                                                <a class="link1" href="Javascript:PopUpAddEdit('0','');">Add New Forwarding <IMG height="26" src="<%=request.getContextPath()%>/Images/icon_add_new.gif" width="26" align="absMiddle" border="0"></a>
                                            </td>
                                        </tr>
                                    </html:form>
                                </table>
               ...
               <tr>
                    <td width="10">&nbsp;</td>
                    <td class="ver12gray">	
                        <display:table name="shipperList" id="shipper" class="report" requestURI="/shipper/shipper.do"    
                             decorator="com.wings.struts.decorators.ShippersWrapper" pagesize="10">                            
