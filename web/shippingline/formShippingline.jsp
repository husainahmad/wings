        ...
        <tr>
            <td>
                <table cellSpacing="0" cellPadding="10" width="100%" border="0">
                    <tr>
                        <td class="ver12gray" bgColor="#dbdbd4">Add/Edit Shippingline</td>
                    </tr>
                </table>
                            ...
                            <table class="ver10gray" cellSpacing="2" cellPadding="2" width="100%" border="0">
                                ...
                                <tr>
                                    ...
                                    <logic:equal name="action" value="insert">
                                            <html:form action="/insertShippingline" method="POST">
                                            <table border="0" width="100%">
                                                    <jsp:include page="/shippingline/formShippinglineInc.jsp"/>
                                                    <tr>
                                    ...
                                    <logic:equal name="action" value="update">
                                            <html:form action="/updateShippingline" method="POST">
                                            <table border="0" width="100%">
                                                    <jsp:include page="/shippingline/formShippinglineInc.jsp"/>
                                                    <tr>
                                    ...
                                    <logic:equal name="action" value="select">
                                            <html:form action="/selectShippingline" method="POST">
                                            <table border="0" width="100%">
                                                    <jsp:include page="/shippingline/formShippinglineInc.jsp"/>
                                                    <tr>
