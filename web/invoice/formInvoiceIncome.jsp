        ...
        <tr>
            <td>
                <table cellSpacing="0" cellPadding="10" width="100%" border="0">
                    <tr>
                        <td class="ver12gray" bgColor="#dbdbd4">Update Invoice</td>
                    </tr>
                </table>
                            ...
                            <table class="ver10gray" cellSpacing="2" cellPadding="2" width="100%" border="0">
                                ...
                                <tr>
                                    ...
                                    <logic:equal name="action" value="insert">
                                            <html:form action="/insertIncome" method="POST">
                                            <table border="0" width="100%">
                                                    <jsp:include page="/invoice/formInvoiceIncomeInc.jsp"/>
                                                    <tr>
                                                            <td colspan="2"><html:submit value="Update"/></td>
                                                    </tr>
                                                    <tr>
                                                            <td colspan="2"><br/><br/>*use this page for updating invoice status</td>
                                                    </tr>
                                            </table>
                                            </html:form>
                                    </logic:equal>
                                    <logic:equal name="action" value="update">
                                            <html:form action="/updateIncome" method="POST">
                                            <table border="0" width="100%">
                                                    <jsp:include page="/invoice/formInvoiceIncomeInc.jsp"/>
                                                    <tr>
                                                            <td colspan="2"><html:submit value="update"/></td>
