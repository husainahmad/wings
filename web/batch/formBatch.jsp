                                ...
                                <tr>
                                    ...
                                    <td class="ver10gray">	
                                        <logic:equal name="action" value="insert">
                                                <html:form action="/insertBatch" method="POST">
                                                <table border="0">
                                                        <jsp:include page="/batch/formBatchInc.jsp"/>
                                                        <tr>
                                        ...
                                        <logic:equal name="action" value="update">
                                                <html:form action="/updateBatch" method="POST">
                                                <table border="0">
                                                        <jsp:include page="/batch/formBatchInc.jsp"/>
                                                        <tr>
                                        ...
                                        <logic:equal name="action" value="select">
                                                <html:form action="/selectBatch" method="POST">
                                                <table border="0">
                                                        <jsp:include page="/batch/formBatchInc.jsp"/>
                                                        <tr>
