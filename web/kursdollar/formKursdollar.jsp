        ...
        <tr>
            <td>
                <table cellSpacing="0" cellPadding="10" width="100%" border="0">
                    <tr>
                        <td class="ver12gray" bgColor="#dbdbd4">Add/Edit Kurs Dollar</td>
                    </tr>
                </table>
                            ...
                            <table class="ver10gray" cellSpacing="2" cellPadding="2" width="100%" border="0">
                                ...
                                <tr>
                                    ...
                                    <logic:equal name="action" value="insert">
                                            <html:form action="/insertKursdollar" method="POST">
                                            <table border="0">
                                                    <jsp:include page="/kursdollar/formKursdollarInc.jsp"/>
                                                    <tr>
                                    ...
                                    <logic:equal name="action" value="update">
                                            <html:form action="/updateKursdollar" method="POST">
                                            <table border="0">
                                                    <jsp:include page="/kursdollar/formKursdollarInc.jsp"/>
                                                    <tr>
                                    ...
                                    <logic:equal name="action" value="select">
                                            <html:form action="/selectKursdollar" method="POST">
                                            <table border="0">
                                                    <jsp:include page="/kursdollar/formKursdollarInc.jsp"/>
                                                    <tr>
