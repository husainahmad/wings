...
<head>
    ...
    <script>
        ...
        function PopUpAddEdit(id, idAgent) {				
                var url;
                if (id==0) {
                    url = 'newAgent.do';
                } else if (id==1) {
                    url = 'findAgent.do?idAgent=' + idAgent;
                } else if (id==2) {
                    question = confirm('Are you sure want to delete this record?'); 
                    if (question) {
                        window.location='deleteAgent.do?idAgent=' + idAgent;
                        return;
                    } else {
                        return;
                    }
                } else if (id==3) {
                    url = 'viewAgent.do?idAgent=' + idAgent;
                }                 
                popUp('Agent',url,'775','450');
        }		
    </script>
</head>
<body>
            ...
            <table width="100%" border="0" cellspacing="0" cellpadding="0">	
               ...
               <tr>
                        ...
                        <td class="ver12gray">
                                <table cellSpacing="0" cellPadding="0" width="100%" border="0">
                                    <html:form action="/agents" method="GET">
                                        <tr>
                                            <td width="100%">&nbsp;
                                            </td>
                                            ...
                                            <td vAlign="middle" noWrap align="right" width="130">
                                                <a class="link1" href="Javascript:PopUpAddEdit('0','');">Add New Agents <IMG height="26" src="<%=request.getContextPath()%>/Images/icon_add_new.gif" width="26" align="absMiddle" border="0"></a>
                                            </td>
                                        </tr>
                                    </html:form>   
                                </table>
               ...
               <tr>
                    ...
                    <td class="ver12gray">	
                        ...
                        <display:table name="agentsList" id="agents" class="report" requestURI="/agents/agents.do"    
                             decorator="com.wings.struts.decorators.AgentsWrapper" pagesize="10">                            
