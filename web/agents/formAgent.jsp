        ...
        <tr>
            <td>
                <table cellSpacing="0" cellPadding="10" width="100%" border="0">
                    <tr>
                        <td class="ver12gray" bgColor="#dbdbd4">Add/Edit Agent</td>
                    </tr>
                </table>
                            ...
                            <table class="ver10gray" cellSpacing="2" cellPadding="2" width="100%" border="0">
                                ...
                                <tr>
                                    ...
                                    <logic:equal name="action" value="insert">
                                            <html:form action="/insertAgent" method="POST">
                                            <table border="0">
                                                    <jsp:include page="/agents/formAgentInc.jsp"/>
                                                    <tr>
                                                            <td colspan="2"><br><html:submit value="Save"/></td>
                                                    </tr>
                                            </table>
                                            </html:form>
                                    </logic:equal>                                         
                                    <logic:equal name="action" value="update">
                                            <html:form action="/updateAgent" method="POST">
                                            <table border="0">
                                                    <jsp:include page="/agents/formAgentInc.jsp"/>
                                                    <tr>
