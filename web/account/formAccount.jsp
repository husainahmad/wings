                                ...
                                <tr>
                                    ...
                                    <td class="ver10gray">	
                                        <logic:equal name="action" value="insert">
                                                <html:form action="/insertAccount" method="POST">
                                                <table border="0">
                                                        <jsp:include page="/account/formAccountInc.jsp"/>
                                                        <tr>
                                        ...
                                        <logic:equal name="action" value="update">
                                                <html:form action="/updateAccount" method="POST">
                                                <table border="0">
                                                        <jsp:include page="/account/formAccountInc.jsp"/>
                                                        <tr>
                                        ...
                                        <logic:equal name="action" value="select">
                                                <html:form action="/selectAccount" method="POST">
                                                <table border="0">
                                                        <jsp:include page="/account/formAccountInc.jsp"/>
                                                        <tr>
                                                                <td colspan="2"></td>
