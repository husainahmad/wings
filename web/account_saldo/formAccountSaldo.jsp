        ...
        <tr>
            <td>
                <table cellSpacing="0" cellPadding="10" width="100%" border="0">
                    <tr>
                        <td class="ver12gray" bgColor="#dbdbd4">Add/Edit Saldo Akhir  <span id="indicator" style="display:none;">Loading......</span></td>
                    </tr>
                </table>
                                ...
                                <tr>
                                    ...
                                    <td class="ver10gray">	
                                        <logic:equal name="action" value="insert">
                                                <html:form action="/insertAccountSaldo" method="POST">
                                                <table border="0">
                                                    <jsp:include page="/account_saldo/formAccountSaldoInc.jsp"/>
                                                        <tr>
                                        ...
                                        <logic:equal name="action" value="update">
                                                <html:form action="/updateAccountSaldo" method="POST">
                                                <table border="0">
                                                        <jsp:include page="/account_saldo/formAccountSaldoInc.jsp"/>
                                                        <tr>
                                        ...
                                        <logic:equal name="action" value="select">
                                                <html:form action="/selectAccountSaldo" method="POST">
                                                <table border="0">
                                                        <jsp:include page="/account_saldo/formAccountSaldoInc.jsp"/>
                                                        <tr>
                                                                <td colspan="2"></td>
