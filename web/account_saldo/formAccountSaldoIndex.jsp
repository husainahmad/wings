...
<head>
    ...
    <script>
        ...
        function PopUpAddEdit(id, idAccount, bulan, tahun) {				
                var url;
                if (id==0) {
                    url = 'newAccountSaldo.do';
                } else if (id==1) {
                    url = 'findAccountSaldo.do?idAccount=' + idAccount + '&bulan=' + bulan + '&tahun=' + tahun;
                } else if (id==2) {
                    question = confirm('Are you sure want to delete this record?'); 
                    if (question) {
                        window.location='deleteAccountSaldo.do?idAccount=' + idAccount + '&bulan=' + bulan + '&tahun=' + tahun;
                        return;
                    } else {
                        return;
                    }                    
                } else if (id==3) {
                    url = 'viewAccount.do?idAccount=' + idAccount + '&bulan=' + bulan + '&tahun=' + tahun;
                } else if (id==4) {
                    url = 'printAccountSaldo.do';
                }                 
                if (id==4) {
                    popUp('PrintAccount',url,'800','500');
                    return;
                } 
                popUp('Account',url,'600','270');
        }		
    </script>
</head>
<body>
            ...
            <table width="100%" border="0" cellspacing="0" cellpadding="0">	
               ...
               <tr>
                        ...
                        <td class="ver12gray">
                                <table cellSpacing="0" cellPadding="0" width="100%" border="0">
                                    <html:form action="/accountSaldo" method="GET">
                                        <tr>
                                            <td width="100%">&nbsp;
                                            </td>
                                            ...
                                            <td vAlign="middle" noWrap align="right" width="130">
                                                <a class="link1" href="Javascript:PopUpAddEdit('0','');">Add New Saldo Akhir<IMG height="26" src="<%=request.getContextPath()%>/Images/icon_add_new.gif" width="26" align="absMiddle" border="0"></a>
                                            </td>
                                        </tr>
                                    </html:form>
                                </table>
               ...
               <tr>
                    ...
                    <td class="ver12gray">	
                       ...
                       <display:table name="accountSaldo" id="accountSaldo" class="report" requestURI="/account_saldo/accountSaldo.do"    
                             decorator="com.wings.struts.decorators.AccountSaldoWrapper" pagesize="10">                            
                            ...
                            <display:column property="bulan" title="Bulan" sortable="true"/> 
                            <display:column property="tahun" title="Tahun" sortable="true"/>                             
                            <display:column property="saldoAkhirTrans" title="Saldo Akhir" sortable="true"/>                             
