...
function addbaDebit() {                                                   
    ...
    cell10.innerHTML = "<input type=\"button\" value=\"$\" onclick=\"convertToDollarOrRupiah('" + kursValue + "','" + chargeDebit + "','" + kurs + "')\" >";               
}
...
//    var cell8 = new_row.insertCell(7);
    ...
    getDataBilling()+
    "</select>";
    cell2.innerHTML = "<input type=\"text\" name=\"expensesAgentChargeDebit"+dacountexpensesagentDebit+"\" id=\"expensesAgentChargeDebit"+dacountexpensesagentDebit+"\" size=\"20\" onchange=\"countExpenses()\"  onBlur=\"this.value=formatCurrency(this.value);\" style=\"text-align: right;\" onkeydown=\"if(event.keyCode==13) event.keyCode=9;\"/>";
    ...
    cell5.innerHTML = "<select name=\"expensesAgentKursDebit"+dacountexpensesagentDebit+"\" id=\"expensesAgentKursDebit"+dacountexpensesagentDebit+"\" onchange=\"countExpenses()\" onkeydown=\"if(event.keyCode==13) event.keyCode=9;\">"+
    "<option value=\"IDR\">IDR</option>"+
    "<option value=\"USD\">USD</option>"+
    "</select>";
    ...
    //cell7.innerHTML = "<input type=\"checkbox\" name=\"expensesAgentTaxDebit"+dacountexpensesagentDebit+"\" id=\"expensesAgentTaxDebit"+dacountexpensesagentDebit+"\" onclick=\"countExpenses()\" value=\"1\" style=\"text-align:right;\" size=\"10\" onkeydown=\"if(event.keyCode==13) event.keyCode=9;\"/>";
    //cell8.innerHTML = "<input type=\"checkbox\" name=\"expensesAgentVatDebit"+dacountexpensesagentDebit+"\" id=\"expensesAgentVatDebit"+dacountexpensesagentDebit+"\" onclick=\"countExpenses()\" value=\"1\" style=\"text-align:right;\" size=\"10\" onkeydown=\"if(event.keyCode==13) event.keyCode=9;\"/>";
...
//    var cell8 = new_row.insertCell(7);
    ...
    getDataInvoice()+
    "</select>";
    cell2.innerHTML = "<input type=\"text\" name=\"expensesAgentChargeInvoice"+dacountexpensesagentInvoice+"\" id=\"expensesAgentChargeInvoice"+dacountexpensesagentInvoice+"\" size=\"20\" onchange=\"countExpenses()\"  onBlur=\"this.value=formatCurrency(this.value);\" style=\"text-align: right;\" onkeydown=\"if(event.keyCode==13) event.keyCode=9;\"/>";
    ...
    cell5.innerHTML = "<select name=\"expensesAgentKursInvoice"+dacountexpensesagentInvoice+"\" id=\"expensesAgentKursInvoice"+dacountexpensesagentInvoice+"\" onchange=\"countExpenses()\" onkeydown=\"if(event.keyCode==13) event.keyCode=9;\">"+
    "<option value=\"IDR\">IDR</option>"+
    "<option value=\"USD\">USD</option>"+
    "</select>";
    ...
    //cell7.innerHTML = "<input type=\"checkbox\" name=\"expensesAgentTaxInvoice"+dacountexpensesagentInvoice+"\" id=\"expensesAgentTaxInvoice"+dacountexpensesagentInvoice+"\" value=\"1\" onclick=\"countExpenses()\" style=\"text-align:right;\" size=\"10\" onkeydown=\"if(event.keyCode==13) event.keyCode=9;\"/>";
    //cell8.innerHTML = "<input type=\"checkbox\" name=\"expensesAgentVatInvoice"+dacountexpensesagentInvoice+"\" id=\"expensesAgentVatInvoice"+dacountexpensesagentInvoice+"\" value=\"1\" onclick=\"countExpenses()\" style=\"text-align:right;\" size=\"10\" onkeydown=\"if(event.keyCode==13) event.keyCode=9;\"/>";
    cell9.innerHTML = "&nbsp;<input type=\"button\" value=\"$\" onclick=\"convertToDollarOrRupiah('" + kursValue + "','" + chargeDebit + "','" + kurs + "')\" >";               
