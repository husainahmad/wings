...
<html>
<head>
    <title>.: Sriwijaya Air - Pessanger Handling Report System :.</title>
    ...
    <script>
        ...
        function PopUpAddEdit(id, userId) {				
                var url;
                if (id==0) {
                    url = 'newUser.do';
                } else if (id==1) {
                    url = 'findUser.do?userId=' + userId;
                } else if (id==2) {
                    //url = 'deleteUser.do?userId=' + userId;
                } else if (id==3) {
                    url = 'viewUser.do?userId=' + userId;
                }                 
                popUp('users',url,'465','300');
        }		
    </script>
</head>
<body>
            ...
            <table width="100%" border="0" cellspacing="0" cellpadding="0">	
                                ...
                                <table cellSpacing="0" cellPadding="0" width="100%" border="0">
                                        <tr>
                                                ...
                                                <td vAlign="middle" noWrap align="right" width="130">
                                                  <a class="link1" href="Javascript:PopUpAddEdit('0','');">Add New User <IMG height="26" src="<%=request.getContextPath()%>/Images/icon_add_new.gif" width="26" align="absMiddle" border="0"></a>
                                                </td>
                                        </tr>
                                </table>
                        </td>
               ...
               <tr>
                    ...
                    <td class="ver12gray">	
                        ...
                        <display:table name="userList" id="user" class="report" requestURI="/users/user.do"    
                             decorator="com.sriwijaya.shr.web.struts.decorators.UserWrapper" pagesize="10">                            
                            <display:column property="userId" title="User Id" sortable="true"/>
                            <display:column property="name" title="Name" sortable="true"/>
                            <display:column property="districtId" title="District" sortable="true"/>
