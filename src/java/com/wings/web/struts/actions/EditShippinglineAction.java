...
/**
 * Open form for editing shippingline.
 *
 * @author <a href="http://boss.bekk.no/boss/middlegen/">Middlegen</a>
 *
 * @struts.action
 *    path="/struts/editShippingline"
 *
 * @struts.action-forward
 *    name="form"
 *    path="/struts/formShippingline.jsp"
 *    redirect="false"
 *

 */
public final class EditShippinglineAction extends Action {
   ...
   public ActionForward perform(
      ...
      try {
         ...
         session.setAttribute("shippinglineForm", shippinglineForm);
      } catch (Exception e) {
