...
/**
 * Displays a tax. We'll first try to look for a tax
 ...
 *    name="view"
 *    path="/struts/viewTax.jsp"
 *    redirect="false"
 *

 */
public final class ViewTaxAction extends Action {
   ...
   public ActionForward perform(
      ...
      TaxForm taxForm = (TaxForm)request.getAttribute("tax");
      if( taxForm == null ) {
      ...
      // Make a map that can be used to identify this Tax in any links
      HashMap urlParams = new HashMap();
  urlParams.put("idTax",taxForm.getIdTax());
