...
/**
 * Displays a jobtype. We'll first try to look for a jobtype
 ...
 */
public final class ViewJobtypeAction extends Action {
   ...
   public ActionForward execute(
      ...
      JobtypeForm jobtypeForm = (JobtypeForm)request.getAttribute("jobtype");
      if( jobtypeForm == null ) {
         ...
         try {
            ...
            jobtypeForm = com.wings.adapter.StrutsJobtypeDelegate.edit(jobtypeForm);
      ...
      // Make a map that can be used to identify this Jobtype in any links
      HashMap urlParams = new HashMap();
  urlParams.put("idJobType",jobtypeForm.getIdJobType());
