...
public final class PrintMonthlySalesAIAction extends Action {       
   ...
   private List getHandlingReportDetailSummary(HttpServletRequest request) throws IllegalAccessException, InvocationTargetException, Exception {
        ...
        globalList = com.wings.adapter.StrutsJobsheetDelegate.selectReportMonthlySales(ds);  
        List iList = com.wings.adapter.StrutsJobsheetDelegate.selectReportMonthlySalesInvoiceAI(ds);
