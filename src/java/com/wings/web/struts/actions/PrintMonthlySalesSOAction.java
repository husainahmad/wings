...
import com.wings.persistence.JobsheetDetailSO;
...
public final class PrintMonthlySalesSOAction extends Action {       
   ...
   public ActionForward execute(
      ...
      throws IOException, ServletException {
        ...
        try                        
        {
            ...
            JasperCompileManager.compileReportToFile(context.getRealPath("/reports/MonthlySalesSO.jrxml")); 
            String reportFileName = context.getRealPath("/reports/MonthlySalesSO.jasper");
   ...
   private List getHandlingReportDetailSummary(HttpServletRequest request) throws IllegalAccessException, InvocationTargetException, Exception {
        ...
        globalList = com.wings.adapter.StrutsJobsheetDelegate.selectReportMonthlySalesSO(ds);  
        List iList = com.wings.adapter.StrutsJobsheetDelegate.selectReportMonthlySalesInvoiceSO(ds);
