...
public final class PrintJobsheetaoHeaderAction extends Action {
   ...
   private void executeAOReportDouble(HttpServletRequest request, 
        ...
        String reportFileName = context.getRealPath("/jobsheet/JobsheetAOHeader.jasper");
        File reportFile = new File(reportFileName);
        if (!reportFile.exists()) {
            JasperCompileManager.compileReportToFile(context.getRealPath("/jobsheet/JobsheetAOHeader.jrxml"));
        }
