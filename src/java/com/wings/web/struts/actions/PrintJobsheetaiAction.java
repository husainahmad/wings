...
public final class PrintJobsheetaiAction extends Action {
...
//                  }                                    
        ...
        JasperCompileManager.compileReportToFile(context.getRealPath("/jobsheet/JobsheetAINew.jrxml"));
        String reportFileName = context.getRealPath("/jobsheet/JobsheetAINew.jasper");
   ...
   private Object[][] parseListToArrayDetailBiaya(List list, JobsheetForm jobsheetForm) throws Exception {        
        ...
        try {
            for (int i=0; i<list.size();i++) {
                ...
                dj.setDescription2(dj.getDescription2());
