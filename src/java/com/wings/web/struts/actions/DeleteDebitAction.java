...
public final class DeleteDebitAction extends Action {

   Logger log = Logger.getLogger(DeleteDebitAction.class.getName());          
   ...
   public ActionForward execute(
      ...
      try {          
         ...
         com.wings.adapter.StrutsDebitDelegate.remove(debitForm);
