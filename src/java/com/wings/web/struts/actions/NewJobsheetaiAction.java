...
public final class NewJobsheetaiAction extends Action {
...
//          request.setAttribute("destinations", destinations);
          ...
          jobsheetaiDetailForm.setCreditNoteIDR(new Double(0));
          jobsheetaiDetailForm.setCreditNoteUSD(new Double(0));
