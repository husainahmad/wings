...
public final class PrintRefundAction extends Action {       
   ...
   public ActionForward execute(
      ...
      throws IOException, ServletException {
        ...
        try                        
        {
            ...
            list = this.listCustomerData(list, request);
   ...
   private List listCustomerData(List repList, HttpServletRequest request) {
   ...
   private List getHandlingReportDetailSummary(HttpServletRequest request) throws IllegalAccessException, InvocationTargetException, Exception {
        ...
        List list = com.wings.adapter.StrutsJobsheetDelegate.selectReportRefund(ds);                               
        return list;
    }
