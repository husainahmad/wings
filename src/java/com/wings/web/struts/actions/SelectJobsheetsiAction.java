...
public final class SelectJobsheetsiAction extends Action {
	...
	public ActionForward execute (
		...
		try {
                    ...
                    List jobsheetsis = com.wings.adapter.StrutsJobsheetDelegate.selectByidJobTypeSI(monthYearForm);
                    request.setAttribute("jobsheetsis", jobsheetsis);
