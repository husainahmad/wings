...
public final class PrintJobsheetsoAction extends Action {
   ...
   private void executeSOReportDouble(HttpServletRequest request, ServletContext context, JobsheetKey jobsheetKey, 
        ...
        JasperCompileManager.compileReportToFile(context.getRealPath("/jobsheet/JobsheetSONew.jrxml"));
        String reportFileName = context.getRealPath("/jobsheet/JobsheetSONew.jasper");
        ...
        parameters.put("ShippingLine", shippinglineForm.getIdShippingLine());
        parameters.put("ShippingLineName", shippinglineForm.getName());
