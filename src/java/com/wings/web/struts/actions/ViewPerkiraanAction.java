...
/**
 * Displays a perkiraan. We'll first try to look for a perkiraan
 ...
 *
 * @struts.action
 *    path="/struts/viewPerkiraan"
 *
 * @struts.action-forward
 *    name="view"
 *    path="/struts/viewPerkiraan.jsp"
 *    redirect="false"
 *

 */
public final class ViewPerkiraanAction extends Action {
   ...
   public ActionForward execute (
      ...
      PerkiraanForm perkiraanForm = (PerkiraanForm)request.getAttribute("perkiraan");
      if( perkiraanForm == null ) {
         // The vo wasn't on the request. We came via a direct link.
         // Get pk data from request object and use delegate to lookup
         try {
            perkiraanForm = new PerkiraanForm();
      ...
      // Make a map that can be used to identify this Perkiraan in any links
      HashMap urlParams = new HashMap();
  urlParams.put("idPerkiraan",perkiraanForm.getIdPerkiraan());
