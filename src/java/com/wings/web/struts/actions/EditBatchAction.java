...
/**
 * Open form for editing batch.
 *
 * @author <a href="http://boss.bekk.no/boss/middlegen/">Middlegen</a>
 *
 * @struts.action
 *    path="/struts/editBatch"
 *
 * @struts.action-forward
 *    name="form"
 *    path="/struts/formBatch.jsp"
 *    redirect="false"
 *

 */
public final class EditBatchAction extends Action {
   ...
   public ActionForward perform(
      ...
      try {
         ...
         session.setAttribute("batchForm", batchForm);
      } catch (Exception e) {
