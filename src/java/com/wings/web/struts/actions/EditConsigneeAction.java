...
/**
 * Open form for editing consignee.
 *
 * @author <a href="http://boss.bekk.no/boss/middlegen/">Middlegen</a>
 *
 * @struts.action
 *    path="/struts/editConsignee"
 *
 * @struts.action-forward
 *    name="form"
 *    path="/struts/formConsignee.jsp"
 *    redirect="false"
 *

 */
public final class EditConsigneeAction extends Action {
   ...
   public ActionForward execute(
      ...
      try {
         ...
         session.setAttribute("consigneeForm", consigneeForm);
      } catch (Exception e) {
