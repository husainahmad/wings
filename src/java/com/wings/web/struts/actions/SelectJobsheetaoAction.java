...
public final class SelectJobsheetaoAction extends Action {
	...
	public ActionForward execute (
		...
		//JobsheetaoForm jobsheetaoForm = (JobsheetaoForm)form;
		...
		try {
                    ...
                    List jobsheetaos = com.wings.adapter.StrutsJobsheetDelegate.selectByidJobTypeAO(monthYearForm);
			
                    request.setAttribute("jobsheetaos", jobsheetaos);
