...
/**
 * Open form for editing agentfee.
 *
 * @author <a href="http://boss.bekk.no/boss/middlegen/">Middlegen</a>
 *
 * @struts.action
 *    path="/struts/editAgentfee"
 *
 * @struts.action-forward
 *    name="form"
 *    path="/struts/formAgentfee.jsp"
 *    redirect="false"
 *

 */
public final class EditAgentfeeAction extends Action {
   ...
   public ActionForward execute(
      ...
      try {
         ...
         session.setAttribute("agentfeeForm", agentfeeForm);
      } catch (Exception e) {
         getServlet().log("Create error", e);
         request.setAttribute("name", "Agentfee");
