...
public final class InsertJobsheetsoAction extends Action {
   Logger log = Logger.getLogger(InsertJobsheetsoAction.class.getName()); 
   ...
   public ActionForward execute (
      ...
      try {
         ...
         String finalKey = "WGL-" + String.valueOf(atddate.getYear()).substring(2) + StringUtils.leftPad(String.valueOf(atddate.getMonthOfYear()), 2, "0") + StringUtils.leftPad(jobsheet.getJobNo(),4,"0") + " SO";         
