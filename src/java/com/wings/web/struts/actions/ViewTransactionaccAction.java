...
/**
 * Displays a transactionacc. We'll first try to look for a transactionacc
 ...
 *
 * @struts.action
 *    path="/struts/viewTransactionacc"
 *
 * @struts.action-forward
 *    name="view"
 *    path="/struts/viewTransactionacc.jsp"
 *    redirect="false"
 *

 */
public final class ViewTransactionaccAction extends Action {
   ...
   public ActionForward perform(
      ...
      TransactionaccForm transactionaccForm = (TransactionaccForm)request.getAttribute("transactionacc");
      if( transactionaccForm == null ) {
         ...
         try {
            ...
            request.setAttribute("name", "Transactionacc");
            return mapping.findForward("ejb-finder-exception");
         }
      }

      // Make a map that can be used to identify this Transactionacc in any links
      HashMap urlParams = new HashMap();
  urlParams.put("idTransactionAcc",transactionaccForm.getIdTransactionAcc());
