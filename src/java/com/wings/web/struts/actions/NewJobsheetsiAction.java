...
public final class NewJobsheetsiAction extends Action {
...
//          
          ...
          jobsheetsiDetailForm.setCreditNoteIDR(new Double(0));
          jobsheetsiDetailForm.setCreditNoteUSD(new Double(0));
