...
/**
 * Open form for editing perkiraan.
 *
 * @author <a href="http://boss.bekk.no/boss/middlegen/">Middlegen</a>
 *
 * @struts.action
 *    path="/struts/editPerkiraan"
 *
 ...
 */
public final class EditPerkiraanAction extends Action {
   ...
   public ActionForward execute (
      ...
      try {
         ...
         session.setAttribute("perkiraanForm", perkiraanForm);
      } catch (Exception e) {
