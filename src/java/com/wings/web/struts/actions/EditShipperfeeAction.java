...
/**
 * Open form for editing shipperfee.
 *
 * @author <a href="http://boss.bekk.no/boss/middlegen/">Middlegen</a>
 *
 * @struts.action
 *    path="/struts/editShipperfee"
 *
 * @struts.action-forward
 *    name="form"
 *    path="/struts/formShipperfee.jsp"
 *    redirect="false"
 *

 */
public final class EditShipperfeeAction extends Action {
   ...
   public ActionForward execute(
      ...
      try {
         ...
         session.setAttribute("shipperfeeForm", shipperfeeForm);
      } catch (Exception e) {
         getServlet().log("Create error", e);
         request.setAttribute("name", "Shipperfee");
