...
/**
 * Open form for editing shipper.
 *
 * @author <a href="http://boss.bekk.no/boss/middlegen/">Middlegen</a>
 *
 * @struts.action
 *    path="/struts/editShipper"
 *
 ...
 */
public final class EditShipperAction extends Action {
   ...
   public ActionForward execute(
      ...
      try {
         ...
         session.setAttribute("shipperForm", shipperForm);
      } catch (Exception e) {
         getServlet().log("Create error", e);
         request.setAttribute("name", "Shipper");
