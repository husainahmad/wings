...
/**
 * Displays a debit. We'll first try to look for a debit
 ...
 *
 * @struts.action
 *    path="/struts/viewDebit"
 *
 * @struts.action-forward
 *    name="view"
 *    path="/struts/viewDebit.jsp"
 *    redirect="false"
 *

 */
public final class ViewDebitAction extends Action {
   ...
   public ActionForward execute(
      ...
      // Make a map that can be used to identify this Debit in any links
      HashMap urlParams = new HashMap();
  urlParams.put("idDebit",debitForm.getIdDebit());
