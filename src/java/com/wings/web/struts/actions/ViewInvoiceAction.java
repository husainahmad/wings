...
/**
 * Displays a invoice. We'll first try to look for a invoice
 ...
 *
 * @struts.action
 *    path="/struts/viewInvoice"
 *
 * @struts.action-forward
 *    name="view"
 *    path="/struts/viewInvoice.jsp"
 *    redirect="false"
 *

 */
public final class ViewInvoiceAction extends Action {
   ...
   public ActionForward execute(
      ...
      InvoiceForm invoiceForm = (InvoiceForm)request.getAttribute("invoice");
      if( invoiceForm == null ) {
      ...
      // Make a map that can be used to identify this Invoice in any links
      HashMap urlParams = new HashMap();
  urlParams.put("idInvoice",invoiceForm.getIdInvoice());
