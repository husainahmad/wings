...
public final class SelectAccountSaldoAction extends Action {
	...
	public ActionForward execute (
		...
		try {
                    ...
                    List accounts = com.wings.adapter.StrutsAccountSaldoDelegate.findByDate(monthYearForm);		
                    request.setAttribute("accountSaldo", accounts);
