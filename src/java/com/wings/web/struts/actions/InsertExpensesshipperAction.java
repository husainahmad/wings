...
public final class InsertExpensesshipperAction extends Action {
   ...
   public ActionForward execute(
      ...
      try {
         ...
         expensesshipperForm = com.wings.adapter.StrutsExpensesshipperDelegate.create(expensesshipperForm);
