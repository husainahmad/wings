...
/**
 * Open form for editing expensesagent.
 *
 * @author <a href="http://boss.bekk.no/boss/middlegen/">Middlegen</a>
 *
 * @struts.action
 *    path="/struts/editExpensesagent"
 *
 ...
 */
public final class EditExpensesagentAction extends Action {
   ...
   public ActionForward execute(
      ...
      try {
         ...
         session.setAttribute("expensesagentForm", expensesagentForm);
      } catch (Exception e) {
