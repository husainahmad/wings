...
public final class InsertJobsheetaoAction extends Action {
   Logger log = Logger.getLogger(InsertJobsheetaoAction.class.getName());  
   ...
   public ActionForward execute (
    ...
    totalExpensesUSD = 0.0; 
      ...
      try {
         ...
         String finalKey = "WGL-" + String.valueOf(atddate.getYear()).substring(2) + StringUtils.leftPad(String.valueOf(atddate.getMonthOfYear()), 2, "0") + StringUtils.leftPad(jobsheet.getJobNo(), 4, "0") + " AO";
         jobsheetForm.setJobNo(finalKey);                           
         
         jobsheetForm = com.wings.adapter.StrutsJobsheetDelegate.create(jobsheetForm);
         JobsheetKey jobsheetKey = com.wings.adapter.StrutsJobsheetDelegate.findLastJobsheetKey();
