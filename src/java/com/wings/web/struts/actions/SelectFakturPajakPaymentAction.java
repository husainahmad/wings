...
public final class SelectFakturPajakPaymentAction extends Action {
	...
	public ActionForward execute (
		...
		MonthYearForm monthYearForm = (MonthYearForm)form; 
                try {
                    ...
                    List list = com.wings.adapter.StrutsJobsheetDelegate.selectUnPaymentStatementOfAccountAllStatusByMonthAndYear(monthYearForm);
