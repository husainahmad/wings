...
public final class InsertBillingshipperAction extends Action {
   ...
   public ActionForward execute(
      ...
      try {
         ...
         billingshipperForm = com.wings.adapter.StrutsBillingshipperDelegate.create(billingshipperForm);
