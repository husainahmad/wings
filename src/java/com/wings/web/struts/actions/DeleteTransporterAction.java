...
public final class DeleteTransporterAction extends Action {
   
   Logger log = Logger.getLogger(DeleteTransporterAction.class.getName());          
   ...
   public ActionForward execute (
      ...
      try {
         com.wings.adapter.StrutsTransporterDelegate.remove(transporterForm);
      } catch (Exception e) {
         log.info(e); 
