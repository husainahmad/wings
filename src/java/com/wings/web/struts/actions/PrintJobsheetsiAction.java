...
public final class PrintJobsheetsiAction extends Action {
        ...
        for (int i=0; i<jobList.size();i++) {
          ...
          ShippinglineForm  shippinglineForm  = new ShippinglineForm();
            try {
                ...
                shippingLine += shippinglineForm.getName() + " ";
            } catch (Exception e) {
            }
...
//                  }
        ...
        JasperCompileManager.compileReportToFile(context.getRealPath("/jobsheet/JobsheetSINew.jrxml"));
        String reportFileName = context.getRealPath("/jobsheet/JobsheetSINew.jasper");
        ...
        parameters.put("ShippingLine", shippingLine);
        parameters.put("ShippingLineName", shippingLine);
   ...
   private void executeSIReport(HttpServletRequest request, 
        ...
        parameters.put("ShippingLine", jobsheetsiDetailForm.getShippingLine());
