 ...
 *
 * @struts.form name="shipperForm"
 */
public class ShipperForm extends ActionForm {
   ...
   public ActionErrors validate(ActionMapping mapping, HttpServletRequest request) {
      ...
      // test for nullity
      if(getIdShipper() == null) {
         errors.add("idShipper", new ActionError("error.idShipper.required"));
      }
      if(getName() == null) {
