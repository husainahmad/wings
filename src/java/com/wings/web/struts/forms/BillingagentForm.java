...
/**
 * Form for billingagent.
 *
 * @author <a href="http://boss.bekk.no/boss/middlegen/"/>Middlegen</a>
 *
 * @struts.form name="billingagentForm"
 */
public class BillingagentForm extends ActionForm {

   private final static SimpleDateFormat FORMAT = new SimpleDateFormat("dd.MM.yyyy hh:mm:ss");

   private java.lang.Integer _idbillingAgent = null;
    ...
    */
   public BillingagentForm() {
   }

   /**
    * Returns the idbillingAgent
    *
    * @return the idbillingAgent
    */
   public java.lang.Integer getIdbillingAgent() {
      return _idbillingAgent;
   }

   /**
    * Sets the idbillingAgent
    *
    * @param idbillingAgent the new idbillingAgent value
    */
   public void setIdbillingAgent(java.lang.Integer idbillingAgent) {
      _idbillingAgent = idbillingAgent;
   }
   /**
   ...
   public ActionErrors validate(ActionMapping mapping, HttpServletRequest request) {
      ...
      // test for nullity
      if(getIdbillingAgent() == null) {
         errors.add("idbillingAgent", new ActionError("error.idbillingAgent.required"));
      }
