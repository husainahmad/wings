 ...
 *
 * @struts.form name="jobsheetaiForm"
 */
public class JobsheetaiForm extends ActionForm {
    ...
    */
   public JobsheetaiForm() {
   }

   /**
    * Returns the idJobSheetAi
    *
    * @return the idJobSheetAi
    */
   ...
   /**
    * Sets the idJobSheetAi
    *
    * @param idJobSheetAi the new idJobSheetAi value
    */
   public void setIdJobSheetAi(java.lang.Integer idJobSheetAi) {
      _idJobSheetAi = idJobSheetAi;
   }
   /**
    ...
    * Sets the agentTo
    *
    * @param agentTo the new agentTo value
    */
   ...
   public ActionErrors validate(ActionMapping mapping, HttpServletRequest request) {
      ...
      // test for nullity
      if(getIdJobSheetAi() == null) {
         errors.add("idJobSheetAi", new ActionError("error.idJobSheetAi.required"));
      }
