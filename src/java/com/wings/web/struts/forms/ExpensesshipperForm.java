...
/**
 * Form for expensesshipper.
 *
 * @author <a href="http://boss.bekk.no/boss/middlegen/"/>Middlegen</a>
 *
 * @struts.form name="expensesshipperForm"
 */
public class ExpensesshipperForm extends ActionForm {

   private final static SimpleDateFormat FORMAT = new SimpleDateFormat("dd.MM.yyyy hh:mm:ss");

   private java.lang.Integer _idExpensesShipper = null;
   private java.lang.Integer _idJobSheet = null;
   private java.lang.Integer _idAgentFee = null;
    ...
    */
   public ExpensesshipperForm() {
   }

   /**
    * Returns the idExpensesShipper
    *
    * @return the idExpensesShipper
    */
   public java.lang.Integer getIdExpensesShipper() {
      return _idExpensesShipper;
   }

   /**
    * Sets the idExpensesShipper
    *
    * @param idExpensesShipper the new idExpensesShipper value
    */
   public void setIdExpensesShipper(java.lang.Integer idExpensesShipper) {
      _idExpensesShipper = idExpensesShipper;
   }
   /**
   ...
   /**
    * Returns the idAgentFee
    *
    * @return the idAgentFee
    */
   public java.lang.Integer getIdAgentFee() {
      return _idAgentFee;
   }
    ...
    * Sets the idAgentFee
    *
    * @param idAgentFee the new idAgentFee value
    */
   public void setIdAgentFee(java.lang.Integer idAgentFee) {
      _idAgentFee = idAgentFee;
   }
   /**
    * Returns the charge
    *
   ...
   public ActionErrors validate(ActionMapping mapping, HttpServletRequest request) {
      ...
      // test for nullity
      if(getIdExpensesShipper() == null) {
         errors.add("idExpensesShipper", new ActionError("error.idExpensesShipper.required"));
      }
      if(getIdJobSheet() == null) {
         errors.add("idJobSheet", new ActionError("error.idJobSheet.required"));
      }
      if(getIdAgentFee() == null) {
         errors.add("idAgentFee", new ActionError("error.idAgentFee.required"));
      }
    ...
    public void setIdShipperFee(java.lang.Integer idShipperFee) {
        this._idShipperFee = idShipperFee;
    }
